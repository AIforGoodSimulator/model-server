    ...
    def run_iteration(self, max_dt=None):
        ...
        if(self.nodeGroupData):
            for groupName in self.nodeGroupData:
                ...
                self.nodeGroupData[groupName]['N'][self.tidx]           = numpy.clip((self.nodeGroupData[groupName]['numS'][0] + self.nodeGroupData[groupName]['numE'][0] + self.nodeGroupData[groupName]['numI_pre'][0] + self.nodeGroupData[groupName]['numI_sym'][0] + self.nodeGroupData[groupName]['numI_asym'][0] + self.nodeGroupData[groupName]['numQ_E'][0] + self.nodeGroupData[groupName]['numQ_pre'][0] + self.nodeGroupData[groupName]['numQ_sym'][0] + self.nodeGroupData[groupName]['numQ_asym'][0] + self.nodeGroupData[groupName]['numQ_R'][0] + self.nodeGroupData[groupName]['numH'][0] + self.nodeGroupData[groupName]['numR'][0]), a_min=0, a_max=self.numNodes)
                self.nodeGroupData[groupName]['numTested'][self.tidx]   = numpy.count_nonzero(self.nodeGroupData[groupName]['mask']*self.tested)
                self.nodeGroupData[groupName]['numPositive'][self.tidx] = numpy.count_nonzero(self.nodeGroupData[groupName]['mask']*self.positive)
