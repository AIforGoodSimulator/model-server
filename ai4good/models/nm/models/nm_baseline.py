...
def create_new_graph(p: Parameters):
    graph, nodes_per_struct = create_graph(
        p.n_structs,
        0,
        p.total_population,
        p.max_pop_per_struct,
        edge_weight=p.household_weight,
        label="household",
    ...
    graph = link_nodes_by_property(
        graph,
        0,
        p.n_isoboxes,
        nodes_per_struct,
        p.grid_isoboxes,
        p.neighbor_proximity,
        "ethnicity",
        p.neighbor_weight,
        "friendship",
    )
    graph = link_nodes_by_property(
        graph,
        p.dims_isoboxes[0] * p.dims_isoboxes[1],
        p.dims_block1[0] * p.dims_block1[1],
        nodes_per_struct,
        p.grid_block1,
        p.neighbor_proximity,
        "ethnicity",
    ...
    graph = link_nodes_by_property(
        graph,
        p.dims_block1[0] * p.dims_block1[1],
        p.dims_block2[0] * p.dims_block2[1],
        nodes_per_struct,
        p.grid_block2,
        p.neighbor_proximity,
        "ethnicity",
    ...
    graph = link_nodes_by_property(
        graph,
        p.dims_block2[0] * p.dims_block2[1],
        p.dims_block3[0] * p.dims_block3[1],
        nodes_per_struct,
        p.grid_block3,
        p.neighbor_proximity,
        "ethnicity",
