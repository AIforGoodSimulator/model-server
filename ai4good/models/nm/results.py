...
infected_nums["Avg Base Network with Quarantine"] = infected_nums[
    intervention_graphs
].mean(axis=1)
infected_nums["Avg Base Network with 4 Food Queues"] = infected_nums[fq4_graphs].mean(
    axis=1
)
infected_nums["Avg Base Network with 8 Food Queues"] = infected_nums[fq8_graphs].mean(
    axis=1
)
infected_nums["Avg Base Network with 16 Food Queues"] = infected_nums[fq16_graphs].mean(
    axis=1
)
...
infected_nums["Combined (16 Food Queues)"] = infected_nums[fq16int150_graphs].mean(
    axis=1
)
infected_nums[
    "Avg Base Network with 4 Food Queues and 2 months of Quarantine"
] = infected_nums[fq4int60_graphs].mean(axis=1)
infected_nums[
    "Avg Base Network with 8 Food Queues and 2 months of Quarantine"
] = infected_nums[fq8int60_graphs].mean(axis=1)
infected_nums[
    "Avg Base Network with 16 Food Queues and 2 months of Quarantine"
] = infected_nums[fq16int60_graphs].mean(axis=1)


hospitalized_nums["Avg Base Network"] = hospitalized_nums[base_graphs].mean(axis=1)
hospitalized_nums["Avg Base Network with Quarantine"] = hospitalized_nums[
    intervention_graphs
].mean(axis=1)
hospitalized_nums["Avg Base Network with 4 Food Queues"] = hospitalized_nums[
    fq4_graphs
].mean(axis=1)
hospitalized_nums["Avg Base Network with 8 Food Queues"] = hospitalized_nums[
    fq8_graphs
].mean(axis=1)
hospitalized_nums["Avg Base Network with 16 Food Queues"] = hospitalized_nums[
    fq16_graphs
].mean(axis=1)
hospitalized_nums["Combined (4 Food Queues)"] = hospitalized_nums[
    fq4int150_graphs
].mean(axis=1)
hospitalized_nums["Combined (8 Food Queues)"] = hospitalized_nums[
    fq8int150_graphs
].mean(axis=1)
hospitalized_nums["Combined (16 Food Queues)"] = hospitalized_nums[
    fq16int150_graphs
].mean(axis=1)


fatalities_nums["Avg Base Network"] = fatalities_nums[base_graphs].mean(axis=1)
fatalities_nums["Avg Base Network with Quarantine"] = fatalities_nums[
    intervention_graphs
].mean(axis=1)
fatalities_nums["Avg Base Network with 4 Food Queues"] = fatalities_nums[
    fq4_graphs
].mean(axis=1)
fatalities_nums["Avg Base Network with 8 Food Queues"] = fatalities_nums[
    fq8_graphs
].mean(axis=1)
fatalities_nums["Avg Base Network with 16 Food Queues"] = fatalities_nums[
    fq16_graphs
].mean(axis=1)
fatalities_nums["Combined (4 Food Queues)"] = fatalities_nums[fq4int150_graphs].mean(
    axis=1
)
fatalities_nums["Combined (8 Food Queues)"] = fatalities_nums[fq8int150_graphs].mean(
    axis=1
)
fatalities_nums["Combined (16 Food Queues)"] = fatalities_nums[fq16int150_graphs].mean(
    axis=1
)


fatalities_rates["Avg Base Network"] = fatalities_rates[base_graphs].mean(axis=1)
fatalities_rates["Avg Base Network with Quarantine"] = fatalities_rates[
    intervention_graphs
].mean(axis=1)
fatalities_rates["Avg Base Network with 4 Food Queues"] = fatalities_rates[
    fq4_graphs
].mean(axis=1)
fatalities_rates["Avg Base Network with 8 Food Queues"] = fatalities_rates[
    fq8_graphs
].mean(axis=1)
fatalities_rates["Avg Base Network with 16 Food Queues"] = fatalities_rates[
    fq16_graphs
].mean(axis=1)
fatalities_rates["Combined (4 Food Queues)"] = fatalities_rates[fq4int150_graphs].mean(
    axis=1
)
fatalities_rates["Combined (8 Food Queues)"] = fatalities_rates[fq8int150_graphs].mean(
    axis=1
)
fatalities_rates["Combined (16 Food Queues)"] = fatalities_rates[
    fq16int150_graphs
].mean(axis=1)
