...
grid_isoboxes = network_utils.create_grid(dims_isoboxes[0], dims_isoboxes[1], 0)
grid_block1 = network_utils.create_grid(dims_block1[0], dims_block1[1], grid_isoboxes[-1][-1] + 1)
grid_block2 = network_utils.create_grid(dims_block2[0], dims_block2[1], grid_block1[-1][-1] + 1)
grid_block3 = network_utils.create_grid(dims_block3[0], dims_block3[1], grid_block2[-1][-1] + 1)
