...
@typechecked
def run_model(_model: str, _profile: str, user_input_params: str, load_from_cache: bool,
    ...
    if load_from_cache and facade.rs.exists(_mdl.id(), res_id):
        ...
        logger.info("Running model for the user defined camp")
...
# do not save plots now since the standard sol run has been commented out
