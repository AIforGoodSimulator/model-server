...
health_intervent_full = ['Social Distancing', 'Face Covering / Mask Wearing', 'Handwashing', 'Testing for Infectious Diseases', 'Lockdown / Movement Restrictions']
...
activity_gathering_full = ['Administrative such as Registration', 'Food Distribution Queue', 'Health Check and Consultation', 'Recreational Activities and Events', 'Religious Gatherings and Events']
...
def generate_health_intervent_children(id_index):
    children = [html.Div([
        html.P(''), 
        html.Header(health_intervent_full[id_index]), 
        dbc.Label(health_intervent_required[id_index], color='secondary'), 
        dbc.RadioItems(
                ...
                dbc.Row(
                    dbc.Col(
                        dbc.Card([
                            ...
                            html.P(''),
                            dbc.CardFooter(dbc.Button('Run Simulation', id='page-4-button', color='secondary', href='/sim/run_model')),
