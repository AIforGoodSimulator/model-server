...
id_accommodation_area = ['id-accommodation-area-' + x.replace(' ','').lower() for x in accommodation_info]
id_accommodation_no_person = ['id-accommodation-no-person-' + x.replace(' ','').lower() for x in accommodation_info]
id_accommodation_no_unit = ['id-accommodation-no-unit-' + x.replace(' ','').lower() for x in accommodation_info]
