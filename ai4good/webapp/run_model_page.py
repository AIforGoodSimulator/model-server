...
def profile_selector():
    return dbc.Row([
        dbc.Col(
            html.Div([
                html.Label([html.A('Profile', href='https://github.com/AIforGoodSimulator/model-server/blob/master/fs/params/Parameters_mouse-over_des.csv')], style={'font-weight':'bold'}),
                dcc.Dropdown(
                    id='profile-dropdown'
                ),
            ]),
