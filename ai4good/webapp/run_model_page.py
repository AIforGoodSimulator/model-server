...
def profile_selector():
    return dbc.Row([
        dbc.Col(
            html.Div([
                html.A("Profile", href="https://raw.githubusercontent.com/AIforGoodSimulator/model-server/master/fs/params/Parameters_mouse-over_des.csv", style={'font-weight': 'bold'}),
                dcc.Dropdown(
                    id='profile-dropdown'
                ),
            ]),
